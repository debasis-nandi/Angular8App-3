...
;(function ($, window, document, undefined) {    
  ...
  var defaults = {    
    ...
    selectedLabelLeft: "Hidden Columns",
	selectedLabelRight: "Visible Columns",
  ...
  Plugin.prototype = {
    init: function () {
      ...
      this.$leftHead = $('<div class="lwms-filterhead"> '+this.options.selectedLabelLeft+'</div>').appendTo(this.$leftDiv);
      this.$rightHead = $('<div class="lwms-filterhead"> '+this.options.selectedLabelRight+'</div>').appendTo(this.$rightDiv);      
