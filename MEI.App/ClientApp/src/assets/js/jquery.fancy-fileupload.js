...
(function($) {
	...
	$.fn.FancyFileUpload = function(options) {
		...
		var AddFile = function(uploads, e, data) {
			var inforow = $('<tr><td class="ff_fileupload_preview"><div class="ff_fileupload_fileicon"><img src="images/xls-icon.png"></div><div class="ff_fileupload_actions_mobile"></div></td><td class="ff_fileupload_summary"><div class="ff_fileupload_filename"></div><div class="ff_fileupload_fileinfo"></div><div class="ff_fileupload_buttoninfo ff_fileupload_hidden"></div><div class="ff_fileupload_errors ff_fileupload_hidden"></div><div class="ff_fileupload_progress_background ff_fileupload_hidden"><div class="ff_fileupload_progress_bar"></div></div></td><td class="ff_fileupload_proceed"><a href="file-details.html">Proceed</a></td><td class="ff_fileupload_actions"></td></tr>');
			...
			inforow.find('.ff_fileupload_actions').append($('<button class="upload_cancel_btn">Cancel</button>')).click(RemoveFile);
	...
	// if ( $( ".ff_fileupload_preview_image" ).length ) {
    // $('.ff_fileupload_dropzone').css("display","none");
	// }
